...
FacilityType::FacilityType(const FacilityType &facility) : FacilityType(facility.getName(), facility.getCategory(), facility.getCost(), facility.getLifeQualityScore(), facility.getEconomyScore(), facility.getEnvironmentScore())
{
}
