...
void Simulation::start()
 {
     ...
     while (isRunning)
     {
         ...
         if (words[0] == "step") {
            ...
            // Assuming "planStatus" needs to get an id and output string representation of the plan
            b = new PrintPlanStatus(std::stoi(words[1]));
        } else if (words[0] == "changePolicy") {
            // Assuming "changePolicy" needs to get an id and modify plan with the new policy
